...
En cuanto a la modelización, se compararán distintos algoritmos de \textit{machine learning}, incluyendo modelos como Random Forest y XGBoost, para determinar cuál ofrece el mejor rendimiento en la predicción de resultados. La evaluación de los modelos se realizará mediante una partición temporal de los datos y particiones internas de validación para el ajuste de hiperparámetros, utilizando métricas adecuadas de predicción probabilística, complementadas con métricas tradicionales como la accuracy o el F1-score. Finalmente, se considerará el uso de redes neuronales como alternativa adicional.
