...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{|c|p{3cm}|X|}
        ...
        \hline
        1 & \textit{por definir} & Revisión bibliográfica y selección de fuentes de datos. Estudio del repositorio StatsBomb Open Data y definición del alcance del problema. \\
        2 & \textit{por definir} & Descarga y construcción del dataset de eventos. Implementación del script de descarga y verificación de integridad. \\
        3 & \textit{por definir} & Análisis exploratorio de datos (EDA). Estudio de la distribución de clases, análisis temporal, correlaciones y limitaciones del dataset. \\
        4 & \textit{por definir} & Ingeniería de características. Construcción del dataset de modelado con variables acumuladas, de ventana deslizante y derivadas. \\
        5 & \textit{por definir} & Modelado inicial. Entrenamiento del modelo Random Forest con búsqueda de hiperparámetros. \\
        6 & \textit{por definir} & Modelado comparativo. Entrenamiento de XGBoost y SVM lineal. Evaluación comparativa de los tres modelos. \\
        7 & \textit{por definir} & Análisis de resultados e interpretabilidad. Análisis de importancia de variables y evaluación temporal por minuto. \\
        8 & \textit{por definir} & Redacción de la memoria y desarrollo del prototipo de despliegue. \\
        \hline
    \end{tabularx}
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{|p{5cm}|p{2.8cm}|X|}
        ...
        \hline
        Integración del modelo en una solución interactiva & Pendiente & El modelo final (XGBoost) está serializado y listo para su integración. El desarrollo del prototipo de aplicación web está en curso. \\
        \hline
    \end{tabularx}
