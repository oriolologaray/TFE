...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{|p{2.8cm}|p{1.8cm}|p{2.2cm}|X|}
        ...
        Prepartido                                    &
        65--70\,\% de precisión                       &
        El sistema desarrollado iguala su rango de precisión en predicción intrapartido, sin estadísticas históricas previas al encuentro. Sin embargo, opera con menos información disponible.                                              \\
        \hline
        ...
        Revisión                                      &
        Sin métrica única                             &
        Contextualiza los resultados obtenidos dentro del rango habitual en la literatura. La clasificación multiclase en fútbol es reconocida como un problema de alta dificultad.                                                         \\
        \hline
        ...
        Utilizan la misma fuente de datos (StatsBomb Open Data). Su enfoque valora acciones individuales; el de este TFM las agrega en métricas temporales. Los enfoques son complementarios y validan mutuamente la riqueza de la fuente. \\
        \hline
        Zhang et al.\ (2022)                          &
        Intrapartido                                  &
        Supera a ML clásico                           &
